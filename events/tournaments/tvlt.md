...
<label class="custom-checkbox-container"><input type="checkbox" value="classical" checked onchange="searchTable()"><span class="checkmark"></span> Classical (Cờ chậm)</label></div></div>
